...
class DatasourceUrlEnvironmentPostProcessorTest {
	...
	void shouldConvertPostgresqlUrlToJdbcUrl() {
		...
		assertThat(environment.getProperty("spring.datasource.url"))
				.isEqualTo("jdbc:postgresql://aws-1-sa-east-1.pooler.supabase.com:6543/postgres?user=postgres&password=secret");
	...
	void shouldKeepJdbcUrlUnchanged() {
		MockEnvironment environment = new MockEnvironment()
				.withProperty("spring.datasource.url", "jdbc:postgresql://localhost:5432/postgres");
