...
public record WorkplaceModel(UUID id, UUID clinicId, String name, String description, boolean active) {
	...
	public static WorkplaceModel create(UUID clinicId, String name, String description) {
