...
public record CreateUserRequestDto(
		...
		@Schema(example = "maria.silva@clinic.local")
		String email,
		...
		@Pattern(regexp = "^[A-Z_]+$", message = "role must be uppercase, e.g. ADMIN")
		@Schema(example = "DOCTOR", allowableValues = {"ADMIN", "RECEPTIONIST", "DOCTOR"})
		String role
) {
}
