...
public class SwaggerUiRedirectController {
	...
	ServletRegistrationBean<jakarta.servlet.http.HttpServlet> swaggerUiRootRedirectServlet(
		...
		jakarta.servlet.http.HttpServlet redirectServlet = new jakarta.servlet.http.HttpServlet() {
			...
			@Override
			protected void doHead(jakarta.servlet.http.HttpServletRequest req,
					jakarta.servlet.http.HttpServletResponse resp) throws java.io.IOException {
				doGet(req, resp);
			}
		};

		ServletRegistrationBean<jakarta.servlet.http.HttpServlet> registrationBean = new ServletRegistrationBean<>(
				redirectServlet, "/swagger-ui.html");
