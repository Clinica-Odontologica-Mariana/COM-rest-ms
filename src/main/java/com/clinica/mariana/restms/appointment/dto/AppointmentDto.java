...
public record AppointmentDto(UUID id, UUID patientId, String patientName, UUID clinicId, UUID workplaceId,
		UUID procedureId, UUID professionalId, String professionalName, UUID statusId, String statusCode,
		String statusName, String calendarSyncStatusCode, String externalCalendarEventId, OffsetDateTime lastSyncedAt,
