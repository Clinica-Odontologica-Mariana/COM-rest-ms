...
public record ClinicModel(UUID id, UUID addressId, String name, String document, String phone, String email,
	...
	public static ClinicModel create(UUID addressId, String name, String document, String phone, String email,
			String timezone) {
